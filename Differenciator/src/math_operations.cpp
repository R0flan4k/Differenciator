...
MathOperation MATH_OPERATIONS_ARRAY[] = {
    create_math_operation("+", MATH_OPERATION_TYPES_BINARY, math_op_addition),
    create_math_operation("-", MATH_OPERATION_TYPES_BINARY, math_op_subtraction),
    create_math_operation("*", MATH_OPERATION_TYPES_BINARY, math_op_multiplication),
    create_math_operation("/", MATH_OPERATION_TYPES_BINARY, math_op_division),
    create_math_operation("^", MATH_OPERATION_TYPES_BINARY, math_op_power),
    create_math_operation("sin", MATH_OPERATION_TYPES_UNARY, math_op_sinus),
    create_math_operation("cos", MATH_OPERATION_TYPES_UNARY, math_op_cosinus),
};
